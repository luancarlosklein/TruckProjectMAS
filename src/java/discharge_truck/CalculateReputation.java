...
@Override
   public Object execute(TransitionSystem ts, 
	 ...
	 {
		  ts.getAg().delBel(Literal.parseLiteral("reputation(worker" + (i+1) +  ",_,_)"));
		  ts.getAg().delBel(Literal.parseLiteral("reputationLevel(worker" + (i+1) +  ",_,_)"));
		  ts.getAg().addBel(Literal.parseLiteral("reputation(" + workes[i] + "," + reputations1[i] + "," + reputations2[i] + ")"));
		  ts.getAg().addBel(Literal.parseLiteral("reputationLevel(" + workes[i] + "," + reputationsConf1[i] + "," + reputationsConf2[i] + ")"));
	 }
	  return true;
   } 
